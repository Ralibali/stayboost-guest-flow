      ...
      <div className="mx-auto max-w-[1120px] px-6">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-[color:var(--ink)]/75">
            StayBoost används i den dagliga driften på Bergs Slussar Glamping vid Göta kanal. Här
            visas anläggningens samlade resultat för 2026. Siffrorna visar vad som har hänt på Bergs
            och är ingen garanti för andra boenden.
          </p>
        </div>
