    ...
    <section className="rounded-[24px] border border-[#2d684c]/15 bg-[#f2f8f4] p-5 sm:p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h2 className="mt-2 font-[Fraunces] text-2xl font-semibold">Svarsförslag för gästfrågor</h2>
              ...
              {items.map((item) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    >
                      <span className={`block h-3 w-3 rounded-full bg-white transition ${item.enabled ? "translate-x-3" : ""}`} />
                    </button>
